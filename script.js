...
function createSiteConfig(remoteConfig) {
    ...
    return {
        ...
        textos: {
            mensajeInvitado: 'Qué alegría celebrar contigo',
...
function getEventDateFromConfig() {
    ...
    return new Date(eventDate || '2026-10-24T16:00:00').getTime();
}
...
const translations = {
  es: {
    ...
    names_text: "Veintisiete años de sueños, aprendizajes y momentos inolvidables. Quiero celebrar este nuevo capítulo rodeado de las personas que hacen mi vida más especial.",
    invitado_mensaje: "Qué alegría celebrar contigo",
    invitado_lugares: "Guardamos un lugar para ti: {pases}",
    ...
    itinerary_item_2: "Formalidades - Brindis de celebración",
    itinerary_item_3: "Servicio de cena",
    itinerary_item_4: "Baile",
    itinerary_item_5: "Corte del pastel",
    itinerary_item_6: "Baile",
    ...
    dresscode_text: "Elige un look Tropical Disco Chic: outfits con glitter y shimmer para celebrar esta noche con mucho estilo.",
    moodboard_subtitulo: "Referencias de estilo",
    btn_dresscode: "Ideas de Vestuario",
    gifts_title: "Regalo",
    gifts_text: "Tu presencia es el mejor regalo. Si deseas obsequiarle algo a Tony, cualquier detalle elegido con cariño será recibido con mucha alegría.",
    ...
    wishes_text: "Déjale a Tony un mensaje bonito para recordar siempre esta celebración.",
    ...
    wa_si: "¡Hola! Soy {nombre}. Confirmo mi asistencia al cumpleaños número 27 de Tony Lopez el 24 de octubre. Asistiré con {pases} {pases_label}.",
    wa_no: "¡Hola! Soy {nombre}. Lamentablemente, no podré asistir al cumpleaños número 27 de Tony Lopez el 24 de octubre.",
    calendar_url: "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Tony%20Lopez%27s%2027th%20Birthday&dates=20261024T160000/20261024T200000&ctz=America%2FNew_York&details=Tony%20Lopez%27s%2027th%20birthday&location=3029%20Ambersweet%20Pl%2C%20Clermont%2C%20FL%2034711",
    frase_final: "27 años, muchas historias y toda una vida por disfrutar. ¡Que siga la celebración!",
  },
  ...
  en: {
    ...
    names_text: "Twenty-seven years of dreams, lessons, and unforgettable moments. I want to celebrate this new chapter surrounded by the people who make my life so special.",
    invitado_mensaje: "We're so happy to celebrate with you",
    invitado_lugares: "We've saved a spot for you: {pases}",
    ...
    itinerary_item_1: "Welcome Cocktails",
    itinerary_item_2: "Formalities - Celebration Toast",
    itinerary_item_3: "Dinner Service",
    itinerary_item_4: "Dancing",
    itinerary_item_5: "Cake Cutting",
    itinerary_item_6: "Dancing",
    itinerary_item_7: "Farewell",
    evento1_titulo: "Business Blessing",
    evento1_lugar: "Tony's Home",
    evento2_titulo: "Reception",
    event_note: "Please park along the curb in front of the house and around the house, including Tony's driveway. If it fills up, park at the clubhouse and call Tony at 646 462 0346 for pickup.",
    recepcion_titulo: "Reception",
    btn_location: "View location",
    dresscode_title: "Dress Code",
    dresscode_text: "Choose a Tropical Disco Chic look: outfits with glitter and shimmer to celebrate the night in style.",
    moodboard_subtitulo: "Style References",
    btn_dresscode: "Outfit Ideas",
    gifts_title: "Gift",
    gifts_text: "Your presence is the greatest gift. If you would like to bring Tony something, any thoughtful gesture will be received with heartfelt appreciation.",
    ...
    wishes_text: "Leave Tony a sweet message to remember this celebration forever.",
    ...
    wa_si: "Hi! This is {nombre}. I'm confirming my attendance at Tony Lopez's 27th birthday celebration on October 24th. I'll be attending with {pases} {pases_label}.",
    wa_no: "Hi! This is {nombre}. Unfortunately, I won't be able to attend Tony Lopez's 27th birthday celebration on October 24th.",
    calendar_url: "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Tony%20Lopez%27s%2027th%20Birthday&dates=20261024T160000/20261024T200000&ctz=America%2FNew_York&details=Tony%20Lopez%27s%2027th%20birthday&location=3029%20Ambersweet%20Pl%2C%20Clermont%2C%20FL%2034711",
    frase_final: "27 years, countless memories, and a whole life ahead to enjoy. Let the celebration continue!",
  }
};
