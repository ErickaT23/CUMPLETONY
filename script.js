...
const translations = {
  es: {
    ...
    gifts_text: "Tu presencia es el mejor regalo. Si deseas tener un detalle, celebraremos con lluvia de sobres y regalos.",
  ...
  en: {
    ...
    gifts_text: "Your presence is the greatest gift. If you would like to bring something, there will be an envelope shower and gifts.",
